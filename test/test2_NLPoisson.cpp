...
int main(int argc, char** argv){
	...
	Probl P(1, 295, 0.54, 2.6, 4.29110133911508e-6, 101, 1000, 1e-10, 1.79738, 1.16183675549126e-11, 3.49436549222355e-8, 4.41e-7, 1.4e-3, 
			true, {1, 0}, {2, 3}, 0.00000081, 5, 35, 0.0);
